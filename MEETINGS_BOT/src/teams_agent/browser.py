...
async def join_teams_meeting(meeting_url: str, bot_name: str) -> tuple[Browser, Page, None]:
    ...
    try:
        ...
        await page.screenshot(path=os.path.join(_PROJECT_ROOT, "logs", "debug_continue_timeout.png"))
        logger.error("Timed out waiting for Continue button — see debug_continue_timeout.png")
        raise
