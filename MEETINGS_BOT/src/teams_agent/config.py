...
class Config:
    ...
    # Sarvam and OpenAI LLM pipeline
    ...
    LLM_CHOICE: str = os.getenv("LLM_CHOICE", "openai/gpt-4o-mini")
    ...
    def AZURE_OPENAI_BASE_URL(self) -> str:
        ...
        return f"{endpoint}/openai/deployments/{self.AZURE_OPENAI_DEPLOYMENT_NAME}?api-version={self.OPENAI_API_VERSION}"
