...
class MeetingSession:
    ...
    def __init__(
        ...
        self._join_time: datetime | None = None

    @property
    def join_time(self) -> datetime | None:
        """Return the UTC datetime when the current meeting was joined."""
    ...
    async def join_meeting(
        ...
        self._join_time = datetime.now(tz=timezone.utc)
        self._clock = Clock()
    ...
    async def open_chat_panel(self) -> None:
        ...
        async with self.animation("reading"):
            await self._meeting_provider.open_chat_panel()
